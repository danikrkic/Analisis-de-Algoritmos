...
{
    int i, j, minFila, PuntoSillaTotales;
    PuntoSillaTotales = 0;
    (*contador) += 5;
    ...
    if(PuntoSillaTotales != 0)
    {
        printf("Total de puntos silla: %d \n\n", PuntoSillaTotales);
    }
    else{
            printf("No se encontraron puntos silla \n\n");
    }
    return -1;
...
void casos(FILE *fp)
{
    ...
    {
    case 1:
        fp = fopen("RegistroB-MejorCaso.csv", "w");
        for (i = 2; i < TAM + 2; i++)
        {
    ...
    case 2:
        fp = fopen("RegistroB-PeorCaso.csv", "w");
        for (i = 2; i < TAM + 2; i++)
        {
            Matriz = GeneradorMatriz(tam, opcion);
            contador = 0;
    ...
    default:
        fp = fopen("RegistroB-Aleatorio.csv", "w");
        for (i = 2; i < TAM + 2; i++)
        {
            Matriz = GeneradorMatriz(tam, opcion);
            contador = 0;
